...
def manage_menu(request):
    if request.method == 'POST' :
        ...
        if not ((request.user.is_superuser) or (request.user.cafe_manager)):
            ...
            if cat.lower() == 'soups':
                listing_order = 1
            elif cat.lower() == 'salad':
                listing_order = 2
            elif cat.lower() == 'bar bites':
                listing_order = 3
            elif cat.lower() == 'egg':
                listing_order = 4
            elif cat.lower() == 'Staight outta Tandoori':
                listing_order = 5
            elif cat.lower() == 'pizza':
                listing_order = 6
            elif cat.lower() == 'appateizer':
                listing_order = 7
            elif cat.lower() == 'rice':
                listing_order = 8
            elif cat.lower() == 'noodles':
                listing_order = 9
            elif cat.lower() == 'Pasta':
                listing_order = 10
            elif cat.lower() == 'sandwich':
                listing_order = 11
            elif cat.lower() == 'platters':
                listing_order = 12
            elif cat.lower() == 'bread':
                listing_order = 13
            elif cat.lower() == 'main course':
                listing_order = 14
            elif cat.lower() == 'milkshake':
                listing_order = 15
            elif cat.lower() == 'mocktails':
                listing_order = 16
            
            
            if listing_order is None:
                # Handle the case where cat doesn't match any condition
                # You can assign a default value or raise an error
